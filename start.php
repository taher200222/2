                    ...
                    if(checkMail($mail)){
                        ...
                        if ($inInsta !== false) {
                            // if($config['filter'] <= $follow){
                                ...
                                $following = $info['ff'];
                                $media = $info['m'];
                                bot('sendMessage', ['disable_web_page_preview' => true, 'chat_id' => $id, 'text' => "HNODENew Account. ✅
تم الصيد بواسطة ملك الساحة هنودي ال ثكيل!
★★★★★★★★★★★★
...
.★. 𝐅𝐎𝐋𝐋𝐎𝐖𝐈𝐍𝐆 : $following\n 
.★. 𝐏𝐎𝐒𝐓 : $media\n
.★. 𝐇𝐎𝐔𝐑𝐒 : ".date("Y")."/".date("n")."/".date("d")." : " . date('g:i') . "\n" . " 
قناتي تليكرام-لتواصل-او لبلاغ عن خطا!
 [Ch: @ttemtim  M: @MQMQM0༗ ]",
