...
'content-type: application/x-www-form-urlencoded; charset\u003dUTF-8',
'cookie: wlidperf=FR=L&ST=1622391383327; mkt=ar-AE; MUID=1ASppKbVqcX1NxQrxsjNnkWLMMtQDnmvrx; MSFPC=GUID=41375879ac0c40aab1baf2e092c2e3ee&HASH=4137&LV=202105&V=4&LU=1622391356285; amsc=:2:3c; clrc={%2218792%22%3a[%22d7PFy/1V%22%2c%22+VC+x0R6%22%2c%22FutSZdvn%22]}',
'hpgact: 0',
'hpgid: 200639',
'origin: https://signup.live.com',
'referer: https://signup.live.com/signup?lcid\u003d1033\u0026wa\u003dwsignin1.0\u0026rpsnv\u003d13\u0026ct\u003d1623589734\u0026rver\u003d7.0.6737.0\u0026wp\u003dMBI_SSL\u0026wreply\u003dhttps%3a%2f%2foutlook.live.com%2fowa%2f%3fnlp%3d1%26signup%3d1%26RpsCsrfState%3d14685491-4f68-fb9b-5c62-cbcdd6e90a59\u0026id\u003d292841\u0026CBCXT\u003dout\u0026lw\u003d1\u0026fl\u003ddob%2cflname%2cwld\u0026pcexp\u003dfalse\u0026cobrandid\u003d90015\u0026lic\u003d1\u0026uaid\u003de0dc2f7925154b72a8f2dab999b6d82c',
'sec-fetch-mode: cors',
...
function checkGmx($mail){
  ...
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL,"https://onereg-email-suggest.gmx.com/email-alias/availability");
  curl_setopt($ch,CURLOPT_HTTPHEADER, [
    'Host: onereg-email-suggest.gmx.com',
'Connection: keep-alive',
'User-Agent: Mozilla/5.0 (Linux; Android 10; SM-A105FN) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.101 Mobile Safari/537.36',
...
function checkprotonmail($url,$mail){
    $mail = trim($mail);
    if(strpos($mail, ' ') or strpos($mail, '+')){
        return false;
    }
...
'origin: https://account.protonmail.com/signup?language\u003den',
'referer: https://account.protonmail.com/signup?language\u003den',
'sec-fetch-mode: cors',
'sec-fetch-site: same-origin',
'user-agent: Mozilla/5.0 (Linux; Android 10; SM-A105FN) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.101 Mobile Safari/537.36'
    ]);
...
function checkMHR($mail){
  ...
  curl_setopt($ch,CURLOPT_HTTPHEADER, [
    'Host: http://onereg-email-suggest.mail.com',
'Connection: keep-alive',
'User-Agent: Mozilla/5.0 (Linux; Android 10; SM-A105FN) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.101 Mobile Safari/537.36',
'Accept: application/json, text/plain, */*',
