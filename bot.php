...
if(!file_exists('config.json')){
	$token = readline('-خلي توكين بوتك Enter Token: ');
	$id = readline('- خلي ايدي حسابك Enter Id: ');
	...
	$callback = function ($update, $bot) {
      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendMessage([
                  'chat_id'=>$chatId,
                  'text'=>"-تم التفعيلبواسطة هنودي ال ثكيلM . \n - To Your IG Bussines Tool. \n\n By ~ @ZSS7SZ قناتي @ttemtim ",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'🛃اضافه حساب وهمي انستكرام','callback_data'=>'login']],
                          [['text'=>'منين تريد تصيد :','callback_data'=>'grabber']],
                          [['text'=>'✔️بلش فحص ','callback_data'=>'run'],['text'=>'❌ كافي صيد شبعت','callback_data'=>'stop']],
                          [['text'=>'♻️ شنو وضع الاداه بشرني','callback_data'=>'status']],
                      ]
                  ])
              ]);   
          } elseif($text != null){
          	if($config['mode'] != null){
          		...
          		$ig = new ig(['file'=>'','account'=>['useragent'=>'Instagram 176.0.0.38.116 Android (23/6.0.1; 640dpi; 1440x2392; LGE/lge; RS988; h1; h1; en_US)']]);
		              ...
		              $keyboard['inline_keyboard'][] = [['text'=>'ولك رجعني','callback_data'=>'back']];
		              $bot->editMessageText([
		                  'chat_id'=>$chatId,
		                  'message_id'=>$mid,
          		  ...
          		  if(is_numeric($text)){
                      ...
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                      'text'=>"-تم التفعيل بواسطة هنودي ال ثكيلM . \n - To Your IG Bussines Tool. \n\n By ~@ZSS7SZZ  قناتي : @ttemtim",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'🛃اضافه حساب وهمي انستكرام','callback_data'=>'login']],
                          [['text'=>'منين تريد تصيد :','callback_data'=>'grabber']],
            ...
            $bot->editMessageText([
                ...
                'reply_markup'=>json_encode([
                    'inline_keyboard'=>[
                        ...
                        [['text'=>'⚠️ قائمه جديده','callback_data'=>'newList'],['text'=>'⚠️ قائمه قديمه','callback_data'=>'append']],
                        [['text'=>'❎ ولك رجعني','callback_data'=>'back']],
                    ]
                ])
            ]);
          } elseif($data == 'search'){
              ...
              $bot->editMessageText([
          	  ...
          	  $bot->editMessageText([
                  ...
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'🛃اضافه حساب وهمي انستكرام','callback_data'=>'login']],
                          [['text'=>'📮منين تريد تصيد :رات','callback_data'=>'grabber']],
                          [['text'=>'✔️بلش فحص ','callback_data'=>'run'],['text'=>'❌ كافي صيد شبعت','callback_data'=>'stop']],
                          [['text'=>'♻️ شنو وضع الاداه بشرني','callback_data'=>'status']],
                      ]
                  ])
